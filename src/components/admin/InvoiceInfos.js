      ...
      <div>
        <div>
          ...
          <table width="100%">
            <tbody>
              <tr>
                <td className={classes.center}><b>{orgUnit.ancestors[2] === undefined || orgUnit.ancestors[2].id === orgUnit.id ? "Zone" : "Woreda"}</b></td>
                <td className={classes.center}><b>{orgUnit.ancestors[2] === undefined || orgUnit.ancestors[2].id === orgUnit.id ? "" : "Zone"}</b></td>
